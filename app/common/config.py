...
class Settings(BaseSettings):
    ...
    @computed_field
    def MODEL_DEVICE(self) -> bool:
        return False if self.TORCH_DEVICE_MODEL == "cpu" else True

    # Text detection
    DETECTOR_BATCH_SIZE: Optional[int] = 16 # Defaults to 2 for CPU/MPS, 32 otherwise
    ...
    DETECTOR_TEXT_THRESHOLD: float = 0.3 # Threshold for text detection (above this is considered text)
    ...
    RECOGNITION_BATCH_SIZE: Optional[int] = 64 # Defaults to 8 for CPU/MPS, 256 otherwise
