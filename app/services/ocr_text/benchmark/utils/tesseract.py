...
from app.services.ocr_text.surya.input.processing import slice_bboxes_from_image
from app.services.ocr_text.surya.settings import settings
import os
from concurrent.futures import ProcessPoolExecutor
from app.services.ocr_text.surya.recognition.languages import CODE_TO_LANGUAGE
