...
from app.services.ocr_text.surya.table_rec.schema import TableCell, TableRow, TableCol, TableResult
...
from app.services.ocr_text.surya.table_rec.loader import TableRecModelLoader
from app.services.ocr_text.surya.table_rec.model.config import BOX_PROPERTIES, SPECIAL_TOKENS, BOX_DIM, CATEGORY_TO_ID, MERGE_KEYS, \
    MERGE_VALUES
from app.services.ocr_text.surya.table_rec.shaper import LabelShaper
