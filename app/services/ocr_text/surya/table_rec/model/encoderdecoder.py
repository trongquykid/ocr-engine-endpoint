...
from app.services.ocr_text.surya.table_rec.model.decoder import SuryaTableRecDecoder
from app.services.ocr_text.surya.table_rec.model.encoder import DonutSwinModel
