...
from app.services.ocr_text.surya.detection.loader import DetectionModelLoader, InlineDetectionModelLoader
from app.services.ocr_text.surya.detection.parallel import FakeExecutor
from app.services.ocr_text.surya.detection.util import get_total_splits, split_image
from app.services.ocr_text.surya.detection.schema import TextDetectionResult
from app.services.ocr_text.surya.settings import settings
from app.services.ocr_text.surya.detection.heatmap import parallel_get_boxes, parallel_get_inline_boxes
