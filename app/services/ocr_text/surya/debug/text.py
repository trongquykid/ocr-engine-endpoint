...
def draw_text_on_image(bboxes, texts, image_size: Tuple[int, int], langs: List[str], font_path=None, max_font_size=60, res_upscale=1):
    ...
    for bbox, text in zip(bboxes, texts):
        ...
        box_font_size = max(6, min(int(1.5 * bbox_height), max_font_size)) * 2
