...
from app.services.ocr_text.surya.recognition.model.config import SuryaOCRConfig, SuryaOCRDecoderConfig, DonutSwinConfig, SuryaOCRTextEncoderConfig
from app.services.ocr_text.surya.recognition.model.encoderdecoder import OCREncoderDecoderModel
