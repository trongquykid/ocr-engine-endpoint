...
from app.services.ocr_text.surya.recognition.model.encoder import DonutSwinModel
from app.services.ocr_text.surya.recognition.model.decoder import SuryaOCRDecoder, SuryaOCRTextEncoder
