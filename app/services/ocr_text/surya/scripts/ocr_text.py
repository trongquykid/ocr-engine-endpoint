...
from app.services.ocr_text.surya.recognition.languages import replace_lang_with_code
from app.services.ocr_text.surya.input.load import load_lang_file
...
from app.services.ocr_text.surya.scripts.config import CLILoader
