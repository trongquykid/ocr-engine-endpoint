...
import click
import os
from app.services.ocr_text.surya.input.load import load_from_folder, load_from_file
...
class CLILoader:
    ...
    def common_options(fn):
        IMG_DIR = "data_test/scan_Mo_tai_khoan_KHTC_page-0001.jpg"
        fn = click.argument("input_path", type=click.Path(exists=True), required=True, default=IMG_DIR)(fn)
        ...
        fn = click.option("--images", is_flag=True, help="Save images of detected bboxes.", default=True)(fn)
